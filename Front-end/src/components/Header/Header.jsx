...
function Header() {
  return (
    ...
    >
      ...
      ></img>
      <h1 className="absolute top-[8rem] text-white font-bold text-2xl left-16 sm:text-6xl sm:top-[12rem] sm:left-[17rem]">
      ...
      <button className="absolute top-[12.5rem] bg-white px-4 py-2 rounded-full left-16 sm:top-[28rem] sm:left-[17rem] sm:px-8 sm:py-3 sm:text-2xl ">
        view Menu
      </button>
    </div>
  );
